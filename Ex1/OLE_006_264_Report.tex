...
\begin{document}
    ...
    \begin{enumerate}
    \item Downloaded and booted. Example code did Store the two first features already
    \item Splitting correctly so the sample could consist of more than only one plant required some trickery, but eventually it was complete.
    \item 
    \end{enumerate}
