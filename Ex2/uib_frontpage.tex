\begin{titlepage}
    ...
    \textsc{\Large INF264}\\[0.5cm] % Major heading such as course name
    \textsc{\large Introduction to Machine Learning}\\[0.5cm] % Minor heading such as course title

    \HRule \\[0.4cm]
    { \huge \bfseries Exercice 2}\\[0.4cm] % Title of your document
    \HRule \\[1.5cm]
